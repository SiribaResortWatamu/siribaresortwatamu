...
update site_settings set
  ...
  address             = 'Watamu Beach Road, Watamu, Kilifi County, Kenya',
  phone               = '+254 700 000 000',
  whatsapp            = '254700000000',
  email               = 'stay@siribaresort.co.ke',
  owner_email         = 'stay@siribaresort.co.ke',
  facebook_url        = 'https://facebook.com/',
  instagram_url       = 'https://instagram.com/',
  map_embed_url       = 'https://www.google.com/maps?q=Watamu,+Kenya&output=embed',
  check_in_time       = '14:00',
  ...
  arrival_information = 'We are on Watamu Beach Road, five minutes from Watamu Marine National Park. Send us your arrival time and we will meet you at the gate.'
where id;
